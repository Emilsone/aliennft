    ...
    const sections = [
        {
            id: 'overview',
            title: 'Overview',
            content: `AlienNFT is built with respect for privacy. This policy explains what information we collect, why we collect it, and how it is used when you visit our website, connect a wallet, buy or trade NFTs, or take part in our ecosystem such as staking, governance, or merchandise rewards.By using any part of the AlienNFT  platform, you agree to the practices described here. If you are not comfortable with them, you should stop using the platform.`,
        },
...

        {
            ...
            content: `We use cookies and similar tools to keep the platform running smoothly and to understand how it is used.Essential cookies support core features like wallet connections and security. Analytics cookies help us see how visitors interact with the site, such as which pages are viewed most. Preference cookies remember choices like theme or language.You can manage non-essential cookies through your browser settings, but some features may not work properly if cookies are disabled.`,
        },

        {
            id: 'blockchain-disclosure',
            title: 'Blockchain and Public Data',
            content: `AlienNFT  runs on the Ethereum blockchain. Blockchain data is public and permanent by nature. Wallet addresses, NFT ownership, staking activity, token balances, and governance votes can be viewed by anyone on the network. We cannot change, hide, or remove blockchain records. If you link a wallet to our platform, that connection may be visible through blockchain analysis. For this reason, you should only use wallet addresses you are comfortable making publicly visible. All $ALIEN token transactions are also recorded on-chain and remain publicly accessible.`,
        },
...

        {
            ...
            content: `We keep personal information only for as long as it is needed. Email addresses are stored until you unsubscribe or request removal. Merchandise records are kept for accounting and tax purposes. Analytics data is stored in anonymized form for a limited time. Blockchain data cannot be deleted and will remain on the Ethereum network indefinitely.`,
        },

        {
            ...
            footer:
                'To make a request, contact us at privacy@AlienNFT .io. We aim to respond within 30 days. Some requests may be limited due to legal obligations or the public nature of blockchain data.',
        },
      ...
      That said, no system is completely risk-free. You are responsible for keeping your wallet, private keys, and recovery phrases secure. AlienNFT  will never ask for your private keys or seed phrases. Any request for them is fraudulent.`,
        },

        {
            id: 'children',
            title: "Children's Privacy",
            content: `AlienNFT  is intended for adults only. We do not knowingly collect information from anyone under 18. If you believe a minor has shared personal data with us, please contact us so we can remove it.
      ...
      NFT and cryptocurrency activity may also be restricted by local laws. It is your responsibility to follow the rules in your jurisdiction.`,
...

        {
            ...
            content: `AlienNFT  operates globally. Your information may be processed in countries outside your own, where data protection laws may differ. When this happens, we take reasonable steps to ensure your data is handled responsibly.`,
        },
        ...
        <main className="bg-[#080808] text-white overflow-x-hidden font-[family-name:var(--font-geist-sans)] ">
            ...
            <section className="relative pt-36 pb-20 px-6 sm:px-16 overflow-hidden border-b border-[#1a1a1a]">
                ...
                <div className="relative z-10 max-w-[860px]">
                    ...
                    <p className="text-white/75 text-base leading-relaxed max-w-2xl border-l-2 border-[rgba(0,255,136,0.25)] pl-5">
                        This document governs how AlienNFT collects, uses, and protects your data across our NFT platform, staking ecosystem, and community channels. Please read it carefully before interacting with our services.
                    </p>
                </div>
            </section>
